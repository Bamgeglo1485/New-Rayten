...
namespace Content.Shared._EinsteinEngines.Contests // Goob Edit
{
    public sealed partial class ContestsSystem : EntitySystem
    {
        ...
        private bool _doContestSystem = true;
        private bool _doMassContests = true;
        private bool _allowClampOverride = true;
        private float _massContestsMaxPercentage = 1f;
        private bool _doStaminaContests = true;
        private bool _doHealthContests = true;
        private bool _doMindContests = true;
