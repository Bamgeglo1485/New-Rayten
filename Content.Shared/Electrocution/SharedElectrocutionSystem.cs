...
namespace Content.Shared.Electrocution
{
    public abstract class SharedElectrocutionSystem : EntitySystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<SkillComponent, ElectrocutionAttemptEvent>(OnSkillElectrocutionAttempt);//vanilla-station
        }
        ...
        //vanilla-station
        private void OnSkillElectrocutionAttempt(EntityUid uid, SkillComponent Skill, ElectrocutionAttemptEvent args)
        {
            if(Skill.EngineeringLevel == SkillLevel.Expert)
            {
