...
CHANGELOG_FILES = [
    ...
    "Resources/Changelog/ChangelogVanilla.yml",
]
...
def main():
    ...
    # Обработка нескольких файлов changelog
    cur_changelog = {}
    for changelog_file in CHANGELOG_FILES:
        with open(changelog_file, "r") as f:
            cur_changelog.update(yaml.safe_load(f))
...
def get_last_changelog_by_sha(
    ...
    """
    Использует GitHub API для получения предыдущих версий всех changelog файлов.
    """
    ...
    for changelog_file in CHANGELOG_FILES:
        ...
        # Добавляем содержимое файла в итоговую строку
        all_changelog_content += resp.text + "\n"

    return all_changelog_content
