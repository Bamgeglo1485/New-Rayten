...
gun-execution-suicide-initial-others = { CAPITALIZE($attacker) } прикладывает свой { $weapon } ко лбу { $victim }.
gun-execution-suicide-initial-self = Вы прикладываете { $weapon } к своему лбу.
gun-execution-initial-others = { CAPITALIZE($attacker) } прикладывает свой { $weapon } ко лбу { $victim }.
gun-execution-initial-self = Вы прикладываете { $weapon } ко лбу { $victim }.
gun-execution-empty-self = Ваш { $weapon } щелкает без выстрела.
gun-execution-empty-others = { $weapon } { CAPITALIZE($attacker) } щелкает без выстрела.
