...
job-name-scientist = доктор
job-name-research-assistant = студент
...
job-name-technical-assistant = технический стажёр
job-name-engineer = инженер-логист
...
JobHeadOfPersonnel = глава отдела кадров
...
JobPassenger = неоплачиваемый стажёр
JobPsychologist = психолог
JobQuartermaster = квартирмейстер
JobReporter = репортёр
JobResearchAssistant = студент
JobResearchDirector = профессор естественных наук
...
JobTechnicalAssistant = технический стажёр
