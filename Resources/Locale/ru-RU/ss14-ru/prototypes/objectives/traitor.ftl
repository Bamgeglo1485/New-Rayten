...
ent-SupercritAnomaliesObjective = { ent-BaseTraitorObjective }
    .desc = Нанотрейзен очень заинтересован в аномалиях с непредсказуемыми последствиями. Покажите им пламя, с которым они играют.
ent-HijackTradeStationObjective = Взломайте торговый пост
    .desc = В ваш аплинк добавлен один маяк взлома. Установите его на торговом посту и защищайте его во время взлома.
ent-MailFraudObjective = { ent-BaseTraitorObjective }
    .desc = Нас интересуют переписки Нанотрейзен. Открывашка для писем не прилагается.
