...
namespace Content.Server.Database.Migrations.Postgres
{
    ...
    [Migration("20260818190217_BarkVoiceAdd")]
            ...
            modelBuilder.Entity("Content.Server.Database.ProfileBasicSkill", b =>
                {
                    b.HasOne("Content.Server.Database.ProfileRoleSkills", "ProfileRoleSkills")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_profile_basic_skill_profile_role_skills_profile_role_skills~");
            ...
            modelBuilder.Entity("Content.Server.Database.ProfileEasySkill", b =>
                {
                    b.HasOne("Content.Server.Database.ProfileRoleSkills", "ProfileRoleSkills")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_profile_easy_skill_profile_role_skills_profile_role_skills_~");
