...
[RegisterComponent, Access(typeof(DiversionistRuleSystem))]
public sealed partial class DiversionistRuleComponent : Component
{
    public readonly List<EntityUid> TraitorMinds = new();

    [DataField]
    public ProtoId<AntagPrototype> TraitorPrototypeId = "Diversionist";
    ...
    [DataField]
    public ProtoId<LocalizedDatasetPrototype> ObjectiveIssuers = "DiversionistCorporations";
