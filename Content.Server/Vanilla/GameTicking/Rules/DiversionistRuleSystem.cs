...
public sealed partial class DiversionistRuleSystem : GameRuleSystem<DiversionistRuleComponent>
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<DiversionistRuleComponent, AfterAntagEntitySelectedEvent>(AfterEntitySelected);
        SubscribeLocalEvent<DiversionistRuleComponent, ObjectivesTextPrependEvent>(OnObjectivesTextPrepend);
    }

    private void AfterEntitySelected(Entity<DiversionistRuleComponent> ent, ref AfterAntagEntitySelectedEvent args)
    {
        Log.Debug($"AfterAntagEntitySelected {ToPrettyString(ent)}");
        MakeTraitor(args.EntityUid, ent);
    }

    public bool MakeTraitor(EntityUid traitor, DiversionistRuleComponent component)
    {
        ...
        _roleSystem.MindHasRole<DiversionistRoleComponent>(mindId, out var traitorRole);
    ...
    private void OnObjectivesTextPrepend(EntityUid uid, DiversionistRuleComponent comp, ref ObjectivesTextPrependEvent args)
    {
    ...
    public List<(EntityUid Id, MindComponent Mind)> GetOtherTraitorMindsAliveAndConnected(MindComponent ourMind)
    {
        ...
        var query = EntityQueryEnumerator<DiversionistRuleComponent>();
    ...
    private List<(EntityUid Id, MindComponent Mind)> GetOtherTraitorMindsAliveAndConnected(MindComponent ourMind, Entity<DiversionistRuleComponent> rule)
    {
