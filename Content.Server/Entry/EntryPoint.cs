...
namespace Content.Server.Entry
{
    public sealed partial class EntryPoint : GameServer
    {
        ...
        //rayten-start
        [Dependency] private DiscordAuthManager _discordauth = default!;
        [Dependency] private JoinQueueManager _queue = default!;
        [Dependency] private SponsorManager _sponsorManager = default!;
        [Dependency] private SharedSponsorManager _sharedsponsor = default!;
        //rayten-end
