...
public sealed partial class TraumaCVars
{
    ...
    public static readonly CVarDef<bool> DisableVisionEffects =
        CVarDef.Create("trauma.disable_vision_effects", false, CVar.CLIENTONLY | CVar.REPLICATED);

    /// <summary>
    /// Whether to disable vision cone overlays.
    /// </summary>
    public static readonly CVarDef<bool> DisableVisionCones =
        CVarDef.Create("trauma.disable_vision_cones", false, CVar.CLIENTONLY | CVar.REPLICATED);
    ...
    public static readonly CVarDef<float> VisionGrainScale =
        CVarDef.Create("trauma.vision_grain_scale", 0.45f, CVar.CLIENTONLY | CVar.ARCHIVE);
}
